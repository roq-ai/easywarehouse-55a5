...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['store-owner', 'inventory-manager', 'customer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Baskets', path: '/baskets', entity: 'basket', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
      name: 'Basket Items',
      path: '/basket-items',
      entity: 'basket_item',
    ...
    { name: 'Sales', path: '/sales', entity: 'sales', service: AccessServiceEnum.PROJECT, icon: FiBox },
