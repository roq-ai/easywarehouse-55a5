...
import { getBasketById } from 'apiSdk/baskets';
import { BasketInterface } from 'interfaces/basket';
import { BasketItemListPage } from 'pages/basket-items';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('basket', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/baskets/edit/${id}`} passHref legacyBehavior>
                    <Button
