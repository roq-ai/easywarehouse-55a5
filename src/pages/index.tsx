...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`easyWarehouse`}</title>

        <meta
          name="description"
          content="Welcome to easyWarehouse, your go-to solution for streamlined store management. Track your inventory, monitor sales, and create standard baskets for efficient grocery store operations."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1607349913338-fca6f7fc42d0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxncm9jZXJ5JTIwc3RvcmV8ZW58MHx8fHwxNjk1MzAwODcxfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to easyWarehouse, your go-to solution for streamlined store management. Track your inventory, monitor sales, and create standard baskets for efficient grocery store operations.`}
            </Text>
            <Box
